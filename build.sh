...
echo ""
echo "开始构建 Simple Music Player v1.2.0..."
echo ""
...
echo "2. DEB安装包: build/simple-music-player-1.2.0-Linux.deb"
echo ""
echo "使用方法："
echo "1. 运行程序: ./build/smp"
echo "2. 安装DEB包: sudo dpkg -i build/simple-music-player-1.2.0-Linux.deb"
echo ""
